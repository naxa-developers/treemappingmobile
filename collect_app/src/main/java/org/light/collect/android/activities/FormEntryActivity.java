...
import org.light.collect.android.adapters.IconMenuListAdapter;
...
import org.light.collect.android.events.ReadPhoneStatePermissionRxEvent;
import org.light.collect.android.events.RxEventBus;
import org.light.collect.android.exception.JavaRosaException;
import org.light.collect.android.external.ExternalDataManager;
import org.light.collect.android.fragments.MediaLoadingFragment;
import org.light.collect.android.fragments.dialogs.CustomDatePickerDialog;
import org.light.collect.android.fragments.dialogs.LocationProvidersDisabledDialog;
import org.light.collect.android.fragments.dialogs.NumberPickerDialog;
import org.light.collect.android.fragments.dialogs.ProgressDialogFragment;
import org.light.collect.android.fragments.dialogs.RankingWidgetDialog;
import org.light.collect.android.listeners.AdvanceToNextListener;
import org.light.collect.android.listeners.FormLoaderListener;
import org.light.collect.android.listeners.FormSavedListener;
import org.light.collect.android.listeners.PermissionListener;
import org.light.collect.android.listeners.SavePointListener;
import org.light.collect.android.location.client.GoogleLocationClient;
import org.light.collect.android.location.client.LocationClient;
import org.light.collect.android.location.client.LocationClients;
import org.light.collect.android.logic.AuditConfig;
import org.light.collect.android.logic.AuditEvent;
import org.light.collect.android.logic.FormController;
import org.light.collect.android.logic.FormController.FailedConstraint;
import org.light.collect.android.logic.FormInfo;
import org.light.collect.android.preferences.AdminKeys;
import org.light.collect.android.preferences.AdminSharedPreferences;
import org.light.collect.android.preferences.GeneralKeys;
...
import org.light.collect.android.tasks.SavePointTask;
import org.light.collect.android.tasks.SaveResult;
import org.light.collect.android.tasks.SaveToDiskTask;
import org.light.collect.android.upload.AutoSendWorker;
import org.light.collect.android.utilities.ActivityAvailability;
import org.light.collect.android.utilities.ApplicationConstants;
import org.light.collect.android.utilities.DependencyProvider;
import org.light.collect.android.utilities.DialogUtils;
import org.light.collect.android.utilities.FileUtils;
import org.light.collect.android.utilities.ImageConverter;
import org.light.collect.android.utilities.MediaManager;
import org.light.collect.android.utilities.MediaUtils;
import org.light.collect.android.utilities.PermissionUtils;
import org.light.collect.android.utilities.SnackbarUtils;
import org.light.collect.android.utilities.SoftKeyboardUtils;
import org.light.collect.android.utilities.ToastUtils;
import org.light.collect.android.views.ODKView;
import org.light.collect.android.widgets.DateTimeWidget;
import org.light.collect.android.widgets.QuestionWidget;
import org.light.collect.android.widgets.RangeWidget;
import org.light.collect.android.widgets.StringWidget;
...
import static org.light.collect.android.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.light.collect.android.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.light.collect.android.utilities.ApplicationConstants.RequestCodes;
import static org.light.collect.android.utilities.PermissionUtils.finishAllActivities;
import static org.light.collect.android.utilities.PermissionUtils.areStoragePermissionsGranted;
