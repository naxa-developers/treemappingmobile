...
public class SharedPreferenceUtils {
    ...
    public static boolean hasEmailSaved() {
        String value = SharedPreferenceUtils.getFromPrefs(Collect.getInstance(), SharedPreferenceUtils.PREF_KEY.USER, "");
        return !TextUtils.isEmpty(value);
    }


    public static String getEmail() {
        return SharedPreferenceUtils.getFromPrefs(Collect.getInstance(), PREF_KEY.USER, "");
    }

    public static void savEmail(String email) {
        SharedPreferenceUtils.saveToPrefs(Collect.getInstance(), PREF_KEY.USER, email);
    }
