...
package org.light.collect.treemappingmobile.database.helpers;
...
import org.light.collect.treemappingmobile.database.DatabaseContext;
import org.light.collect.treemappingmobile.utilities.CustomSQLiteQueryBuilder;

import timber.log.Timber;

import static android.provider.BaseColumns._ID;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.AUTO_DELETE;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.AUTO_SEND;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.BASE64_RSA_PUBLIC_KEY;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.DATE;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.DESCRIPTION;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.DISPLAY_NAME;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.DISPLAY_SUBTEXT;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.FORM_FILE_PATH;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.FORM_MEDIA_PATH;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.JRCACHE_FILE_PATH;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.JR_FORM_ID;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.JR_VERSION;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.LANGUAGE;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.LAST_DETECTED_FORM_VERSION_HASH;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.MD5_HASH;
import static org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns.SUBMISSION_URI;
