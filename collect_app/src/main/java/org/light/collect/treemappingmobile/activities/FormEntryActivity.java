...
import org.light.collect.treemappingmobile.adapters.IconMenuListAdapter;
import org.light.collect.treemappingmobile.adapters.model.IconMenuItem;
...
import org.light.collect.treemappingmobile.dao.helpers.FormsDaoHelper;
import org.light.collect.treemappingmobile.dao.helpers.InstancesDaoHelper;
import org.light.collect.treemappingmobile.events.ReadPhoneStatePermissionRxEvent;
import org.light.collect.treemappingmobile.events.RxEventBus;
import org.light.collect.treemappingmobile.exception.JavaRosaException;
import org.light.collect.treemappingmobile.external.ExternalDataManager;
import org.light.collect.treemappingmobile.fragments.MediaLoadingFragment;
import org.light.collect.treemappingmobile.fragments.dialogs.CustomDatePickerDialog;
import org.light.collect.treemappingmobile.fragments.dialogs.LocationProvidersDisabledDialog;
import org.light.collect.treemappingmobile.fragments.dialogs.NumberPickerDialog;
import org.light.collect.treemappingmobile.fragments.dialogs.ProgressDialogFragment;
import org.light.collect.treemappingmobile.fragments.dialogs.RankingWidgetDialog;
import org.light.collect.treemappingmobile.listeners.AdvanceToNextListener;
import org.light.collect.treemappingmobile.listeners.FormLoaderListener;
import org.light.collect.treemappingmobile.listeners.FormSavedListener;
import org.light.collect.treemappingmobile.listeners.PermissionListener;
import org.light.collect.treemappingmobile.listeners.SavePointListener;
import org.light.collect.treemappingmobile.location.client.GoogleLocationClient;
...
import org.light.collect.treemappingmobile.logic.AuditConfig;
import org.light.collect.treemappingmobile.logic.AuditEvent;
import org.light.collect.treemappingmobile.logic.FormController;
import org.light.collect.treemappingmobile.logic.FormController.FailedConstraint;
import org.light.collect.treemappingmobile.logic.FormInfo;
import org.light.collect.treemappingmobile.preferences.AdminKeys;
import org.light.collect.treemappingmobile.preferences.AdminSharedPreferences;
...
import org.light.collect.treemappingmobile.preferences.PreferencesActivity;
import org.light.collect.treemappingmobile.provider.FormsProviderAPI.FormsColumns;
import org.light.collect.treemappingmobile.provider.InstanceProviderAPI;
import org.light.collect.treemappingmobile.provider.InstanceProviderAPI.InstanceColumns;
import org.light.collect.treemappingmobile.tasks.FormLoaderTask;
import org.light.collect.treemappingmobile.tasks.SaveFormIndexTask;
import org.light.collect.treemappingmobile.tasks.SavePointTask;
import org.light.collect.treemappingmobile.tasks.SaveResult;
import org.light.collect.treemappingmobile.tasks.SaveToDiskTask;
import org.light.collect.treemappingmobile.upload.AutoSendWorker;
import org.light.collect.treemappingmobile.utilities.ActivityAvailability;
import org.light.collect.treemappingmobile.utilities.ApplicationConstants;
import org.light.collect.treemappingmobile.utilities.DependencyProvider;
import org.light.collect.treemappingmobile.utilities.DialogUtils;
...
import org.light.collect.treemappingmobile.utilities.MediaManager;
import org.light.collect.treemappingmobile.utilities.MediaUtils;
import org.light.collect.treemappingmobile.utilities.PermissionUtils;
import org.light.collect.treemappingmobile.utilities.SnackbarUtils;
import org.light.collect.treemappingmobile.utilities.SoftKeyboardUtils;
import org.light.collect.treemappingmobile.utilities.ToastUtils;
import org.light.collect.treemappingmobile.views.ODKView;
import org.light.collect.treemappingmobile.widgets.DateTimeWidget;
import org.light.collect.treemappingmobile.widgets.QuestionWidget;
import org.light.collect.treemappingmobile.widgets.RangeWidget;
import org.light.collect.treemappingmobile.widgets.StringWidget;
...
import static org.light.collect.treemappingmobile.preferences.AdminKeys.KEY_MOVING_BACKWARDS;
import static org.light.collect.treemappingmobile.preferences.GeneralKeys.KEY_BACKGROUND_LOCATION;
import static org.light.collect.treemappingmobile.utilities.ApplicationConstants.RequestCodes;
import static org.light.collect.treemappingmobile.utilities.PermissionUtils.finishAllActivities;
import static org.light.collect.treemappingmobile.utilities.PermissionUtils.areStoragePermissionsGranted;
