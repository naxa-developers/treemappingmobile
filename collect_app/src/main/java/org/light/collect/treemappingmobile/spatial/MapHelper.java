...
package org.light.collect.treemappingmobile.spatial;
...
public class MapHelper {
    ...
    private final org.light.collect.treemappingmobile.spatial.TileSourceFactory tileFactory;
    ...
    public MapHelper(Context context, GoogleMap googleMap, Integer selectedLayer) {
        ...
        tileFactory = new org.light.collect.treemappingmobile.spatial.TileSourceFactory(context);
